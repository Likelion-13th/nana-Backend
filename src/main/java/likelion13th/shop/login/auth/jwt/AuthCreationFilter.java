...
public class AuthCreationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        Authentication exsinting = SecurityContextHolder.getContext().getAuthentication();
        if (exsinting != null && exsinting.isAuthenticated()
        && !(exsinting instanceof AnonymousAuthenticationToken)) {
        ...
        var anonymousAuthorities = java.util.Collections.singletonList(
                new org.springframework.security.core.authority.SimpleGrantedAuthority("Role+ANONYMOUS")
        );
